      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed">
          ...
          <section id="reembolso">
            ...
            <p>
              Você tem direito a <strong>reembolso total em até 7 (sete) dias</strong> após a 
              data da compra, conforme garantido pelo <strong>Código de Defesa do Consumidor 
              (Art. 49)</strong>. Para solicitar o reembolso, entre em contato pelo WhatsApp 
              <strong> (12) 98179-6135</strong> ou pelo e-mail <strong>contato@bateuameta.com.br</strong>.
            </p>
            <p className="mt-2">
              Após o período de 7 dias, não será possível solicitar reembolso, exceto em 
