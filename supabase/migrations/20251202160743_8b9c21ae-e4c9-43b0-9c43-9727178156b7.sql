-- Add outras_despesas column to turnos_km table
ALTER TABLE public.turnos_km 
ADD COLUMN outras_despesas numeric DEFAULT 0;

-- Update the calculate_turno_metrics function to include outras_despesas in lucro_liquido calculation
